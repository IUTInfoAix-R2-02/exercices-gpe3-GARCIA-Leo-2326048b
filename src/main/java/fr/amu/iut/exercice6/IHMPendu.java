...
public class IHMPendu extends Application {
    ...
    private void changerImage(Image pendu7, Image pendu6, Image pendu5, Image pendu4, Image pendu3, Image pendu2, Image pendu1, Image pendu0, ImageView imageView) {
        switch (nbVie) {
            case 0 -> imageView.setImage(pendu0);
            case 1 -> imageView.setImage(pendu1);
            case 2 -> imageView.setImage(pendu2);
            case 3 -> imageView.setImage(pendu3);
            case 4 -> imageView.setImage(pendu4);
            case 5 -> imageView.setImage(pendu5);
            case 6 -> imageView.setImage(pendu6);
            case 7 -> imageView.setImage(pendu7);
        }
    }
